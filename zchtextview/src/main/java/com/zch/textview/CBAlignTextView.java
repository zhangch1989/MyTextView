...
import com.zch.textview.util.CommonUtils;
...
/**
 * Created by Zch on 2020/5/19 16:31.
 *  * 对齐的TextView
 * <p>
...
public class CBAlignTextView extends TextView{
    ...
    private void process(boolean setText) {
        ...
        if (!inProcess && getVisibility() == VISIBLE) {
            ...
            //转化字符，5.0系统对字体处理有所变动
            if (isConvert) {
                oldText = CommonUtils.replacePunctuation(oldText.toString());
            }
